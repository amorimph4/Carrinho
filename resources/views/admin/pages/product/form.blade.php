	    ...
	    <div class="white-box">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-4 chega-pra-la" style="margin-left: 10px;">
		        	<select class="form-control" name="category" id="categorys@{{Product.id}}" required="true">
                  	</select>
			    </div>
			</div>
              	...
              	<div class="col-sm-offset-3">
	              	<div class="fileinput fileinput-new" data-provides="fileinput">
		                <div class="fileinput-new thumbnail">
		                  <img  src="images/placeholder.jpg" id="image-@{{Product.id}}" alt="..." style="height: 180px; width: 250px;">
		                </div>
